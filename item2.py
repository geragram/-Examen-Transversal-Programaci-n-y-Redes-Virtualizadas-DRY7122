...
def mostrar_informacion_viaje(origen, destino, distancia, medio_transporte):
    ...
    narrativa = f"Viajando desde {origen} hasta {destino} en {medio_transporte} cubrirá una distancia de {distancia_km:.2f} km ({distancia_millas:.2f} millas), con una duración aproximada de {duracion_horas:.2f} horas."
    print("\nNarrativa del Viaje:")
    print(narrativa)
...
def main():
    while True:
        ...
        medio_transporte = input("Seleccione el medio de transporte (1. Conduciendo, 2. Caminando, 3. En Bicicleta): ")
